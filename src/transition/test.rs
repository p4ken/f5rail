...
#[rstest]
#[case(緩和曲線(19.0, 0.0), 19)]
#[case(緩和曲線(19.0, 1.0), 19)]
#[case(緩和曲線(19.0, 0.5), 20)]
#[case(緩和曲線(19.5, 0.0), 20)]
...
#[rstest]
#[case(緩和曲線(19.0, 0.0), vec!["301.03", "309.47", "327.59", "358.35", "407.76", "488.43", "630.32", "923.93", "1823", "", "-1823"])]
#[case(緩和曲線(19.0, 1.0), vec!["301.03", "309.47", "327.59", "358.35", "407.76", "488.43", "630.32", "923.93", "1823", "", "-1823"])]
#[case(緩和曲線(19.0, 0.5), vec!["300.26", "304.15", "317.19", "341.11", "380.16", "442.95", "548.50", "746.83", "1222", "3633", "-3633"])]
#[case(緩和曲線(19.5, 0.0), vec!["300.98", "308.98", "326.09", "354.95", "400.80", "474.35", "600.00", "846.01", "1500", "7450", "-2489"])]
